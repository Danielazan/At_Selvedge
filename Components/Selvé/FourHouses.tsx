...
// /* ------------------------------------------------------------------ */
// /* House-card imagery — line-art swatches standing in for product     */
// /* photography, rendered on a warm-lit gradient field so every card   */
// /* still reads as a distinct "photograph" without external assets.    */
// /* Swap the swatch for a real <img src="/imgs/..."> when photography  */
// /* is ready — the surrounding card markup does not need to change.    */
// /* ------------------------------------------------------------------ */
// function HouseArt({ kind, bar }: { kind: House["swatch"]; bar: string }) {
//   return (
//     <div
...
//         style={{ background: `radial-gradient(60% 55% at 50% 40%, ${bar}22, transparent 70%)` }}
//       />
//       {/* fine grain lines, echoes the woven / stitched material language */}
//       <svg className="absolute inset-0 h-full w-full opacity-[0.15]" preserveAspectRatio="none">
//         <defs>
//           <pattern id={`weave-${kind}`} width="10" height="10" patternUnits="userSpaceOnUse">
//             <path d="M0 10L10 0" stroke={GOLD} strokeWidth="0.5" />
//           </pattern>
//         </defs>
//         <rect width="100%" height="100%" fill={`url(#weave-${kind})`} />
//       </svg>

//       <div className="absolute inset-0 flex items-center justify-center p-8">
//         {kind === "denim" && (
//           <svg viewBox="0 0 160 200" className="h-[85%] w-[85%] drop-shadow-[0_18px_30px_rgba(0,0,0,0.55)]">
//             <rect x="14" y="10" width="132" height="180" rx="7" fill="none" stroke={GOLD} strokeOpacity="0.6" strokeWidth="1.4" />
//             <path d="M40 10v180M120 10v180" stroke={GOLD} strokeOpacity="0.32" strokeWidth="1" strokeDasharray="2 7" />
//             <rect x="62" y="58" width="36" height="42" rx="4" fill="none" stroke={GOLD} strokeWidth="1.4" />
//             <circle cx="80" cy="79" r="3" fill={GOLD} />
//             <path d="M30 130c15-8 85-8 100 0" stroke={GOLD} strokeOpacity="0.4" strokeWidth="1.1" />
//           </svg>
//         )}
//         {kind === "jacket" && (
//           <svg viewBox="0 0 160 200" className="h-[85%] w-[85%] drop-shadow-[0_18px_30px_rgba(0,0,0,0.55)]">
//             <path
//               d="M52 30L80 16l28 14 24 18-12 24-12-8v106H64V64l-12 8-12-24 24-18z"
//               fill="none"
//               stroke={GOLD}
//               strokeWidth="1.5"
//               strokeLinejoin="round"
//             />
//             <path d="M80 16v22" stroke={GOLD} strokeWidth="1.2" />
//             <path d="M68 78v70M92 78v70" stroke={GOLD} strokeOpacity="0.35" strokeWidth="1" />
//           </svg>
//         )}
//         {kind === "bottle" && (
//           <svg viewBox="0 0 160 200" className="h-[85%] w-[85%] drop-shadow-[0_18px_30px_rgba(0,0,0,0.55)]">
//             <rect x="62" y="20" width="36" height="20" rx="3" fill="none" stroke={GOLD} strokeWidth="1.4" />
//             <path d="M66 40h28l10 18v112a8 8 0 01-8 8H64a8 8 0 01-8-8V58l10-18z" fill="none" stroke={GOLD} strokeWidth="1.5" />
//             <line x1="58" y1="96" x2="102" y2="96" stroke={GOLD} strokeOpacity="0.45" strokeWidth="1" />
//             <text x="80" y="120" textAnchor="middle" fill={GOLD} fillOpacity="0.55" fontSize="9" letterSpacing="2" fontFamily="serif">
//               LURÈ
//             </text>
//           </svg>
//         )}
...
//           <svg viewBox="0 0 160 200" className="h-[85%] w-[85%] drop-shadow-[0_18px_30px_rgba(0,0,0,0.55)]">
//             <path
//               d="M62 24c0 16 14 18 14 34v96a12 12 0 0012 12h-8a12 12 0 01-12-12V58c0-16-14-18-14-34a18 18 0 0136 0"
//               fill="none"
//               stroke={GOLD}
//               strokeWidth="1.4"
//             />
//             <path d="M55 150c8 6 42 6 50 0" stroke={GOLD} strokeOpacity="0.4" strokeWidth="1" />
//           </svg>
//         )}
//       </div>
//     </div>
...
//       }}
//     >
//       {/* image / product photography area */}
//       <div className="relative h-[210px] shrink-0 xl:h-[230px]">
//         <HouseArt kind={house.swatch} bar={house.bar} />
//         <div
...
/* ------------------------------------------------------------------ */
/* House-card imagery — using actual images from public/imgs          */
/* ------------------------------------------------------------------ */
function HouseArt({ kind, imageSrc, bar }: { kind: House["swatch"]; imageSrc: string; bar: string }) {
  return (
    <div
      className="relative h-full w-full overflow-hidden"
      style={{
    ...
    >
      ...
      {/* Actual image from public/imgs */}
      <div className="absolute inset-0 flex items-center justify-center">
        <Image
          src={imageSrc}
          alt={`${kind} product image`}
          fill
          className="object-contain p-4 drop-shadow-[0_18px_30px_rgba(0,0,0,0.55)]"
          priority
        />
      </div>
...
function HouseCard({ house }: { house: House }) {
  return (
    ...
    >
      {/* image / product photography area */}
      <div className="relative h-[210px] shrink-0 xl:h-[230px]">
        <HouseArt kind={house.swatch} imageSrc={house.imageSrc} bar={house.bar} />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 h-14"
          style={{ background: `linear-gradient(180deg, transparent, ${CARD})` }}
        />
